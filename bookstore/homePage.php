...
<div class="container">
  <div class="name-block">
      <div class="name-block-container">
          <h1><span>LET</span>THE BEACON OF KNOWLEDGE</h1>
          <h2> ILLUMINATE YOUR PATH.</h2>
          <ul class="social">
            <li><a href="https://www.facebook.com/sifato.o2001/"><i class="ion-social-facebook"><img src="facebook.png" alt=""></i></a></li>
            <li><a href="https://www.instagram.com/sifato_o/"><i class="ion-social-Instragram"><img src="instragram.png" alt=""></i></a></li>
            <li><a href="mdsifatullah12@gmail.com"><i class="ion-social-googleplus"><img src="googleplus.png" alt=""></i></a></li>
