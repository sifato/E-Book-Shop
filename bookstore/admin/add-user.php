        ...
        <div id="header-admin">
            ...
            <div class="container">
                ...
                <div class="row">
                    <!-- LOGO -->
                    <div class="col-md-2">
                        <a href="http://localhost/bookstore/homePage.php"><p style=" background: #120d73; padding-left: 35px;font-size: 28px; font-family: cursive; font-weight: bold; color: #fbff00;
                        text-shadow: 0 0 30px #00f3ff; border-radius:30px; ">E-book Shop</p></a>
                    </div>
                    <!-- /LOGO -->
                      <!-- LOGO-Out -->
                    <!-- /LOGO-Out -->
